...
export const BLOG_TOPICS = {
  ...
  'Programação e IA': [
    'Como utilizar seletores CSS para estilizar elementos específicos em uma página web',
    'Transformando interações simples em animações impressionantes com CSS',
    'Aprendendo a manipular eventos de clique em JavaScript para criar experiências interativas',
    'Como usar a biblioteca React para criar componentes reutilizáveis em suas aplicações',
    'Simplificando o gerenciamento de estado em aplicações React com hooks',
    'Como integrar o Next.js para otimizar o SEO das suas páginas web',
    'Utilizando TypeScript para evitar erros comuns e melhorar a qualidade do seu código JavaScript',
    'Como construir um formulário com validação dinâmica usando React e JavaScript',
    'Criando um sistema de comentários em tempo real com React e Firebase',
    'Como fazer requisições HTTP em React usando Axios e gerenciar respostas de APIs',
    'Desmistificando a inteligência artificial: como os LLMs geram texto coerente',
    'Criando perguntas e respostas interativas com prompts em ChatGPT',
    'Como usar Claude para gerar ideias criativas para projetos de programação',
    'Explorando técnicas de fine-tuning para personalizar modelos de linguagem',
    'Como implementar um sistema de recomendação básico usando aprendizado de máquina',
    'A importância da documentação de código e como manter seu projeto organizado',
    'Transformando dados não estruturados em insights acionáveis com RAG',
    'Usando a biblioteca D3.js para visualização de dados impactantes em suas aplicações',
    'Como implementar autenticação em aplicações web utilizando JWT',
    'Construindo uma API RESTful do zero com Express.js e MongoDB',
    'Como usar ferramentas de automação de código como Prettier e ESLint para manter a qualidade do código',
    'Explorando o conceito de programação reativa com RxJS em suas aplicações web',
    'Desenvolvendo funcionalidades acessíveis em aplicações web para atender a todos os usuários',
    'Como implementar um chatbot com inteligência artificial usando o Dialogflow',
    'Usando testes unitários com Jest para garantir a estabilidade do seu código',
    'Como otimizar a performance de suas aplicações web com lazy loading e code splitting',
    'A importância da experiência do usuário na programação web e como melhorá-la',
    'Explorando as diferenças entre frameworks Front-end e Back-end e quando usar cada um',
    'Como implementar um sistema de agendamento de tarefas em uma aplicação React',
    'Usando CSS Grid e Flexbox para criar layouts responsivos e adaptáveis',
    'Como automatizar a geração de relatórios a partir de dados coletados em uma aplicação web',
