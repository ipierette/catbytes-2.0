...
if (!authCode || !codeVerifier) {
  console.error('❌ ERRO: Você precisa fornecer o código de autorização e o code_verifier\n');
  console.log('Uso:');
  console.log('  node scripts/linkedin-exchange-token.js <authorization_code> <code_verifier>\n');
  console.log('Exemplo:');
  console.log('  node scripts/linkedin-exchange-token.js AQTw1OJS_Q2Zc... dBjftJeZ4CVP-mB92K27...\n');
  process.exit(1);
}
